...
(function (PropositionRepas) {
    function handleCommandeDebuterPropositionRepas(commande) {
        Infrastructure.commitEvents([
            new PropositionRepasDebutee(commande.idPropositionRepas(), commande.idUtilisateur(), commande.libelle(), commande.isPrive(), commande.invitations())
        ]);
    }
    ...
    function handleCommandeRenseignerInformationSecondairesPropositionRepas(commande) {
        Infrastructure.commitEvents([new InformationsSecondairesPropositionRepasRenseignees(commande.idPropositionRepas(), commande.description(), commande.heureMaxReservation(), commande.montantMax(), commande.livraisonComprise())]);
    }
    ...
    function handleCommandePublierPropositionRepas(commande) {
        ...
        Infrastructure.commitEvents([new PropositionRepasPubliee(state.idPropositionRepas(), state.libelle(), state.description(), state.heureMaxReservation(), state.montantMax(), state.livraisonComprise(), state.isPrive(), state.invitations())]);
    }
